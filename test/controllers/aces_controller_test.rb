...
class AcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ace" do
    assert_difference('Ace.count') do
      post aces_url, params: { ace: { code: @ace.code, image_url: @ace.image_url, name: @ace.name } }
    end
  ...
  test "should update ace" do
    patch ace_url(@ace), params: { ace: { code: @ace.code, image_url: @ace.image_url, name: @ace.name } }
